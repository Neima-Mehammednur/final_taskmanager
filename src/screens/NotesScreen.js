...
// // //       setIsWriting(false);
// // //       setNewNote({ title: '', content: '', category: 'General' }); // Reset form
// // //     } catch (error) {
...
// // //         <TouchableOpacity style={styles.actionButton} onPress={() => Alert.alert('Upload', 'Upload feature coming soon!')}>
...
// // //             <TouchableOpacity onPress={() => setNewNote({ ...newNote, category: 'General' })}>
// // //               <Text style={styles.modalOption}>General</Text>
// // //             </TouchableOpacity>
// // //             <TouchableOpacity onPress={() => setNewNote({ ...newNote, category: 'Science' })}>
// // //               <Text style={styles.modalOption}>Science</Text>
// // //             </TouchableOpacity>
// // //             <TouchableOpacity onPress={() => setNewNote({ ...newNote, category: 'Math' })}>
// // //               <Text style={styles.modalOption}>Math</Text>
// // //             </TouchableOpacity>
...
// //         const newAttachments = [...newNote.attachments, { type: 'file', uri: result.uri, name: result.name }];
// //         setNewNote({ ...newNote, attachments: newAttachments });
// //       }
// //     } catch (error) {
...
// //       if (!result.cancelled) {
// //         const newAttachments = [...newNote.attachments, { type: 'image', uri: result.uri }];
// //         setNewNote({ ...newNote, attachments: newAttachments });
// //       }
// //     } catch (error) {
...
// //       {/* Upload and Write Buttons */}
// //       <View style={styles.buttonContainer}>
// //         <TouchableOpacity style={styles.actionButton} onPress={handleUploadFile}>
...
// //                 ) : (
// //                   <Text key={index} style={styles.attachmentFile}>{attachment.name}</Text>
// //                 )
// //               ))}
// //             </TouchableOpacity>
// //             <TouchableOpacity onPress={() => handleDeleteNote(item.id)}>
...
//     setNewNote({ ...newNote, attachments: updatedAttachments });
