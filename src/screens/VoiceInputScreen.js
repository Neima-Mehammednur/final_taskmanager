...
//     if (!recognizedText) {
//       Alert.alert('Error', 'Please record a task first.');
//       return;
//     }

//     // Parse the voice input to extract task details (you'll need to customize this)
//     const taskName = recognizedText; // Simple example: use the entire text as the task name
//     const newTask = {
//       id: uuidv4(),
//       name: taskName,
//       description: 'Voice-created task', // You can add more detailed parsing here
...
//       <Text style={styles.title}>Voice Task Creation</Text>
//       <Text style={styles.instructions}>
//         Tap the button to start recording your task.
//       </Text>
